...
class nkyouka{
	...
	public function onKyouka($player){
		////鍛冶屋////
		$npcname = "強化担当";
		$itemid = 346;
		$pk = new AddPlayerPacket();
		$pk->entityRuntimeId = $this->main->k;
		$pk->uuid = UUID::fromRandom();
		$pk->username = $npcname;
		$pk->position = new Vector3(293.5, 68.5, 264.5);
	   	$pk->yaw = 180;
	   	$pk->headYaw = 190;
	 	$pk->pitch = 0;
		...
		$geometryJsonEncoded = base64_decode($this->main->c->get("kaziyageometrydata"));
		if($geometryJsonEncoded !== ""){
			$geometryJsonEncoded = \json_encode(\json_decode($geometryJsonEncoded));
		}
		$skin = new Skin(base64_decode($this->main->c->get("kaziyaskinid")), base64_decode($this->main->c->get("kaziyaskindata")), base64_decode($this->main->c->get("kaziyacapedata")), base64_decode($this->main->c->get("kaziyageometryname")), $geometryJsonEncoded);
		...
		$pk2->entityRuntimeId = $this->main->k;
