...
class nhelper{
	...
	public function onHelper($player){
		////ヘルパー////
		$npcname = "全てを知る者";
		$itemid = 0;
		$pk = new AddPlayerPacket();
		$pk->entityRuntimeId = $this->main->h;
		$pk->uuid = UUID::fromRandom();
		$pk->username = $npcname;
		$pk->position = new Vector3(279.5, 68, 253.3);
	   	$pk->yaw = 40;
	   	$pk->headYaw = 60;
	 	$pk->pitch = 0;
		...
		$geometryJsonEncoded = base64_decode($this->main->c->get("helpgeometrydata"));
		if($geometryJsonEncoded !== ""){
			$geometryJsonEncoded = \json_encode(\json_decode($geometryJsonEncoded));
		}
		$skin = new Skin(base64_decode($this->main->c->get("helpskinid")), base64_decode($this->main->c->get("helpskindata")), base64_decode($this->main->c->get("helpcapedata")), base64_decode($this->main->c->get("helpgeometryname")), $geometryJsonEncoded);
