...
class nshop{
	...
	public function onShop($player){
		////店員////
		$npcname = "店員";
		$itemid = 322;
		$pk = new AddPlayerPacket();
		$pk->entityRuntimeId = $this->main->t;
		$pk->uuid = UUID::fromRandom();
		$pk->username = $npcname;
		$pk->position = new Vector3(292.5, 68, 255.5);
	   	$pk->yaw = 0;
	   	$pk->headYaw = 0;
	 	$pk->pitch = 0;
		...
		$geometryJsonEncoded = base64_decode($this->main->c->get("teningeometrydata"));
		if($geometryJsonEncoded !== ""){
			$geometryJsonEncoded = \json_encode(\json_decode($geometryJsonEncoded));
		}
		$skin = new Skin(base64_decode($this->main->c->get("teninskinid")), base64_decode($this->main->c->get("teninskindata")), base64_decode($this->main->c->get("tenincapedata")), base64_decode($this->main->c->get("teningeometryname")), $geometryJsonEncoded);
		...
		$pk2->entityRuntimeId = $this->main->t;
