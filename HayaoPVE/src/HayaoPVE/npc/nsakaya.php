...
class nsakaya{
	...
	public function onSakaya($player){
		////酒屋////
		$npcname = "酒屋";
		$itemid = 322;
		$pk = new AddPlayerPacket();
		$pk->entityRuntimeId = $this->main->o;
		$pk->uuid = UUID::fromRandom();
		$pk->username = $npcname;
		$pk->position = new Vector3(251.5, 64, 351.5);
	   	$pk->yaw = 180;
	   	$pk->headYaw = 190;
	 	$pk->pitch = 0;
		...
		$geometryJsonEncoded = base64_decode($this->main->c->get("ownergeometrydata"));
		if($geometryJsonEncoded !== ""){
			$geometryJsonEncoded = \json_encode(\json_decode($geometryJsonEncoded));
		}
		$skin = new Skin(base64_decode($this->main->c->get("ownerskinid")), base64_decode($this->main->c->get("ownerskindata")), base64_decode($this->main->c->get("ownercapedata")), base64_decode($this->main->c->get("ownergeometryname")), $geometryJsonEncoded);
		...
		$pk2->entityRuntimeId = $this->main->o;
