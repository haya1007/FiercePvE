...
class ngatya{
	...
	public function onGatya($player){
		////ヘルパー////
		$npcname = "ガッチャマン";
		$itemid = 0;
		$pk = new AddPlayerPacket();
		$pk->entityRuntimeId = $this->main->g;
		$pk->uuid = UUID::fromRandom();
		$pk->username = $npcname;
		$pk->position = new Vector3(332.5, 69, 356.5);
	   	$pk->yaw = 180;
	   	$pk->headYaw = 180;;
	 	$pk->pitch = 0;
		...
		$geometryJsonEncoded = base64_decode($this->main->c->get("gatyageometrydata"));
		if($geometryJsonEncoded !== ""){
			$geometryJsonEncoded = \json_encode(\json_decode($geometryJsonEncoded));
		}
		$skin = new Skin(base64_decode($this->main->c->get("gatyaskinid")), base64_decode($this->main->c->get("gatyaskindata")), base64_decode($this->main->c->get("gatyacapedata")), base64_decode($this->main->c->get("gatyageometryname")), $geometryJsonEncoded);
		...
		$pk2->entityRuntimeId = $this->main->h;
