...
class Sound extends Task{
	function __construct(PluginBase $owner, $pos, $level, $players, $type){
		$this->owner = $owner;
		$this->pos = $pos;
		$this->level = $level;
	...
	function onRun(int $currentTick){
		...
		if($type == 1){
			...
			$pk->sound = LevelSoundEventPacket::SOUND_SHOOT;
		}else{
			$pk->sound = LevelSoundEventPacket::SOUND_SPLASH;			
		}
		$pk->position = $this->pos;
		$this->players->dataPacket($pk);
	}
}