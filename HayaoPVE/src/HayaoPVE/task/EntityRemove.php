...
class EntityRemove extends Task{
	function __construct(PluginBase $owner, $eid){
		$this->owner = $owner;
		$this->eid = $eid;
	}
	...
	function onRun(int $currentTick){
		...
		$this->owner->getServer()->removePlayerListData($this->owner->entity[$eid]["uuid"], $this->owner->getServer()->getOnlinePlayers());
		unset($this->owner->entity[$eid]);
