...
class onEat{
	...
	public function onEat($event){
		$player = $event->getPlayer();
		$name = $player->getName();
		$item = $event->getItem();
		$item_name = $item->getCustomName();
		if($item_name === "§l§b水耐性の酒"){
			$player->addEffect(new EffectInstance(Effect::getEffect(13), 180 * 20, 0, false));
			$player->addEffect(new EffectInstance(Effect::getEffect(16), 180 * 20, 0, false));
		}
	}
}